    ...
    while True:
        ...
        try:
            with urllib.request.urlopen(req) as resp:
                ...
                print(f"Fetched {len(products)} products on page {page}. Total so far: {len(all_products)}")
                page += 1
                if len(products) < 250:
                    break
...
def main():
    ...
    print(f"Total raw products fetched from halahandicraft.com: {len(raw_products)}")
    
    transformed_products = []
    current_id = 1
    
    # First, add the iconic flagship crafts of Ali Akbar Hala Handicraft
    flagship_items = [
        {
            "id": current_id,
            "name": "Authentic Hala Ajrak Shawl (Natural Dye)",
            "category": "ajrak",
            "categoryLabel": "Sindhi Ajrak & Shawls",
            "badge": "Best Seller",
            "price": 2800,
            "image": "https://images.unsplash.com/photo-1621510488241-11d2797ce328?q=80&w=800&auto=format&fit=crop",
        ...
        {
            "id": current_id + 1,
            "name": "Royal Kashi Blue Pottery Vase",
            "category": "kashi",
        ...
        {
            "id": current_id + 2,
            "name": "Hand-Carved Jandi Wooden Jhoola (Swing)",
            "category": "furniture",
        ...
        {
            "id": current_id + 3,
            "name": "Kashi Glazed Ceramic Dinner Set (18 Pc)",
            "category": "kashi",
            "categoryLabel": "Kashi Pottery",
            "badge": "Luxury Dining",
            "price": 16500,
            "image": "https://images.unsplash.com/photo-1615486511484-93e87858c82a?q=80&w=800&auto=format&fit=crop",
            "description": "Complete 18-piece luxury dining collection including hand-glazed dinner plates, curry bowls, serving platters, and water goblets in signature Hala Kashi artwork.",
            "sizes": ["18 Pieces Set", "24 Pieces Set"],
            "colors": ["Persian Blue & White", "Turquoise & Terracotta"]
        },
        {
            "id": current_id + 4,
            "name": "Hand-Embroidered Sindhi Topi (Shisha Work)",
            "category": "topi",
            "categoryLabel": "Sindhi Topi",
            "badge": "Authentic",
            "price": 1400,
            "image": "https://images.unsplash.com/photo-1606240212008-0129df8cb7c5?q=80&w=800&auto=format&fit=crop",
    ...
    # Now process scraped products from halahandicraft.com
    ...
    print(f"Generated total {len(transformed_products)} products.")
    ...
    print("Successfully written to products.json!")
